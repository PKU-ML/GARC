...
from ARC import GARC_calculate
...
def add_learner_params(parser):
    ...
    parser.add_argument('--metric1', default='mean',
        help='the first metric in GARC'
    )
    parser.add_argument('--metric2', default='mean',
        help='the second metric in GARC'
    )
...
def main():
    ...
    GARC_calculate(args, init_model, final_model, device,metric1,metric2)
